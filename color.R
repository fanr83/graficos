...
pal.viridis <- colorRampPalette(c(
    ...
    "#25898C", "#297C8E", "#2E708E", "#34638D", "#3A548A",
...
pal.inferno <- colorRampPalette(c(
    "#FCFFA4", "#FBE975", "#F7D343", "#F9BA2A", "#FAA00F",
    "#F68917", "#EF7122", "#E35D31", "#D54C40", "#C43D4D", 
    "#B03259", "#9B2862", "#862069", "#71196C", "#5B116B", 
    "#440C66", "#2E0D52", "#1A0B3D", "#140623", "#000004"
), space = "Lab")


pal.rocket <- colorRampPalette(c(
     "#03051AFF", "#150E26FF", "#281535FF", "#3C1A42FF", "#511E4DFF",
     "#661F54FF", "#7C1F5AFF", "#931C5BFF", "#AA185AFF", "#C11754FF",
     "#D3214BFF", "#E33541FF", "#ED4E3EFF", "#F26847FF", "#F4815AFF",
     "#F5986FFF", "#F6AE86FF", "#F7C2A2FF", "#F8D7BFFF", "#FAEBDDFF"
), space = "Lab")


pal.turbo <- colorRampPalette(c(
    "#30123BFF", "#3F3994FF", "#455ED2FF", "#4681F7FF", "#3AA2FCFF",
